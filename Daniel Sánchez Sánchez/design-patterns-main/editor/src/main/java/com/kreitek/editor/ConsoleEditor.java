...
import main.java.com.kreitek.editor.Memento.EditorCaretaker;
import main.java.com.kreitek.editor.Memento.Memento;
import main.java.com.kreitek.editor.commands.CommandFactory;
import main.java.com.kreitek.editor.commands.UndoCommand;
...
public class ConsoleEditor implements Editor {
    ...
    private void showHelp() {
        ...
        printLnToConsole("To undo any change -> undo");
    }
    ...
    public int statesSize() {
        return editorCaretaker.size();
    }

    public Memento latestState() {
        return editorCaretaker.getIndex(editorCaretaker.size() - 1);
    }
